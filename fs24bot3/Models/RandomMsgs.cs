...
public class RandomMsgs
{
    public static readonly string[] BanMessages =
    {
        ...
        "Вы были забанены за неуплату долга за игровые услуги",
        "Вы были забанены за использование читов в другой игре",
    };
    ...
    public static readonly string[] MissMessages =
    {
        ...
        "Промахнулись на метр",
        "Выстрел был недостаточно точным",
        "Ваш снаряд ушел мимо цели",
        "Пользователь успел скрыться",
        "Цель оказалась быстрее, чем вы думали",
        "Не удалось попасть в уязвимое место",
        "Мимо, как снаряд от танка на стену",
        "Выстрел не прошел проверку на попадание",
        "Ошибочка вышла, придется стрелять еще раз",
        "Ваш снаряд затерялся в глухих землях",
        "Вы не смогли поймать цель на мушке",
        "Вы промахнулись из-за сильного ветра",
        "Цель оказалась слишком далеко",
        "Выстрел не был точен из-за сильного отдачи",
        "Удача не на вашей стороне, не попали",
    };
    ...
    public static readonly string[] RemindMessages =
    {
        "Remind",
        "Rememberino",
        "Memo",
        ...
        "Звук трубы! Это напоминание",
        "Синяя птица прилетела, чтобы напомнить тебе",
        "Да, тебе нужно это сделать",
        "Чем больше напоминаний, тем больше успеха",
